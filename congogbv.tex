...
In this paper, I explore the characteristics of victims of SGBV as well as non-victims to study the dynamics and potential drivers of SGBV. I classify female survey respondents according to potential risk factors for SGBV, and analyse whether these factors are in fact associated with the incidence of SGBV. In this way, this paper aims to address the question what the drivers of SGBV in Eastern Congo are. 
...
In answering the question what the main drivers of SGBV are, I thus consider two main drivers:  the position of women in Congolese society and conflict. However, within conflict, I distinguish between long-term, indirect, effects and short-term effects. The indirect long-term effects of conflict are likely to be related to the position of women, through changing norms. In the short-term, this indirect effect will not be as noticeable. \todo{why not. EXPAND.}
...
With respect to conflict, I distinguish between recent conflict (as indicated by ACLED events that happened within the 12 months before the list experiment) and historic conflict (1996-2012). Historic conflict can only have an indirect effect on SGBV, e.g. through changed norms. Recent conflict can also have a direct effect through perpetration during the conflict event. The indirect effects of recent conflict exposure will be smaller, since it takes time for norms to change. \todo{laat flowen.}
