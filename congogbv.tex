...
\paragraph{}
Second, I compare across the results of a bargaining game played with couples. Couples first took a decision individually, and then jointly. I then create three groups, based on whether the joint decision is closer to the husband's decision, to the wife's, or if the distance is equal. See figure \ref{fig:meancompare3}. In the group where the couple decision was closest to the wife's decision (n=\incid{barg1}{n}), the average number of issues was \incid{barg1}{mean0} for the control group, and \incid{barg1}{mean1} for the treatment group. This implies a rate of GBV of \incid{barg1}{incidence_pct}\% (p = \incid{barg1}{p}). In the group where the couple decision was equally close to the husband and wife (n=\incid{barg2}{n}), the average number of issues was \incid{barg2}{mean0} for the control group, and \incid{barg2}{mean1} for the treatment group. This implies a rate of GBV of \incid{barg2}{incidence_pct}\% (p = \incid{barg2}{p}). In the group where the couple decision was closest to the husband's (n=\incid{barg3}{n}), the average number of issues was \incid{barg3}{mean0} for the control group, and \incid{barg3}{mean1} for the treatment group. This implies a rate of GBV of \incid{barg3}{incidence_pct}\% (p = \incid{barg3}{p}).
