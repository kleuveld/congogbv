...
%waarom is sexual violence bad? 
%\cite{Post2002} argue the enormous cost of rape and sexual violence. Both tangible and intangible (US).
%\cite{Peterson2018} estimate productivity losses due to sexual violence (US)
%insiration from John?
\paragraph{}
%Research question
This paper aims to answer the following question: what are the characteristics of victims of GBV in Eastern Congo? In particular, I consider conflict victimization, intra-household dynamics, and poverty as potential characteristics.
\paragraph{}
%Antecedents
While estimates for the incidence of GBV in DR Congo vary, they are invariably high, ranging from 15 to 40\% \citep{Johnson2010,Peterman2011}. A frequently cited driver for this high rate, is the conflict that has persisted in the country for the past decades. \cite{Johnson2010} carried out a large-scale survey in Eastern DRC to investigate incidence and perpetrators of GBV. They find that the majority of sexual violence reported in a large-scale survey was conflict-related; of female victims of sexual violence, 74.3\% reported being victim to conflict-related sexual violence. It is therefore not surprising that the topic of GBV in Congo has often been analysed within the context of violence \cite{Baaz2013}. Likewise, the aspect of the conflict that has received the most world-wide media attention has been GBV \cite{Autesserre2012a}.  
...
\paragraph{}
This view of the central role of conflict in sexual violence has come under increasing scrutiny. This focus on the relationship between sexual violence and conflict has been counter-productive, as it has distracted attention from other pressing problems the country faces \citep{Autesserre2012a, Hilhorst2018,Porter2019}. Based on DHS data, \cite{Peterman2011} find that Intimate Partner violence is a large contributor to the incidence of Sexual Violence in Congo. This has fostered an increased awareness in the role of empowerment of women in preventing GBV in the first place \cite{Hilhorst2018}. However, it is clear that to this day, women hold a precarious position in Congolese society. For example, views that men have the right to physically abuse their wife if she is disobedient are broadly held \citep{Quattrochi2019}.
\paragraph{}
\citet{Stark2017} provide a possible explanation why some of the literature see the conflict as a main driver of GBV, while others see civilian-perpetrated GBV as the larger issue. In a study where 87 women and girls in South Kivu were interviewed using Audio Assisted Self-Interviews (ACASI) techniques,they find that 14\% of respondents reported having been victim of sexual coercion. Half of these were perpetrated by the respondents' husbands or boyfriends. Crucially, in complementary group discussions, respondents did not bring up intimate partners at all. This points at the difficulties of collecting accurate data about GBV, and the importance of data collection methodologies. 
\paragraph{}
%Contribution
This paper contributes to the empirical evidence base on the incidence of GBV in Eastern Congo using List Experiments. List Experiments remove the bias in answering sensitive question, by removing the possibility of the researcher to view individual answers. Group-level analysis is still possible, to provide estimates of correlates of GBV. This does come at a cost: since the field staff did not know victimization status of individual respondents, follow-up questions (e.g. on perpetrators) were impossible. However, combined with rich data from a household survey and behavioural experiments, collected in 2012 and 2014, the List Experiment allows for a rich characterization of victims of GBV. This data can be of tremendous usefulness in addressing and preventing GBV.
