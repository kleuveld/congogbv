...
%wie hebben dit gebruikt en hoe?
...
%\cite{Frye2017} use a list experiment to assess the whether Putin's high popularity ratings are caused by reporting bias. (NB: they've got some refs to other political science LEs)
%\cite{Blair2014} perform a lidt experimet to determine the support for ISAF in Afghanistan. They compare list experimets to alternative  inidrect questioning methods. They find that list experiments accurately avoid Social Desirability bias.
% \cite{Bulte2019} compare the results of direct questioning and list experiment to assess the incidence of IPV among beneficiaries of a program to boost female empowerment in Vietnam. They find that using direct questioning yields underestimates of the incidence of IPV. Moreover, the treatment effect of the project reverses its sign when using the List Experiment, compared to using direct questioning. 
