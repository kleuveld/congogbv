...
This increased focus on IPV, rather than conflict, shifts attention from conflict to a lack of female empowerment as a driver of SGBV. Empowerment is a multi-faceted phenomenon, making it hard to measure. \citet{Kabeer1999} distinguishes between three interrelated dimensions: (access to) resources, agency (including the influence on decision making processes) and achievements (well-being outcomes). In this framework, the incidence of SGBV then is the achievement dimension. As an indicator for access to resources, I use  societal norms as an indicator of access to resources, and (intra-household) bargaining power as an indicator for agency. \cite{Mabsout2010} underlines the importance of considering these as separate indicators of empowerment, in finding that they can have different effects on the welfare of women.
