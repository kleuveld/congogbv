...
\begin{abstract}
\section*{Abstract}
The project aims to provide crucial insights into the patterns of gender based violence in Eastern Congo. Of particular interest are covariates of victimization of sexual violence, in order to provide a characterization of victims, as well as identification of drivers of violence
...
%expand this section
The selected of respondents to the gender module is unlikely to have been random. In column 4 of Table \ref{tab:dhs_compare} selected demographics for the Female Respondents to the gender module are presented. The respondents are slightly older than the full sample, and considerably older than the provincial average. They are slighly more likely to have completed secondary school than the full sample, but less likely than the provincial average. Table \ref{tab:attrition} presents results from logit models models to find correlations between household characteristics and particiaption in the gender module. The dependent columns of the columns are whether the wife, the husband and the couple participated in the gender module. There are some selection effects: households where a female respondent is present, are less lilely to own livestock. On the contrary, households where the husband participated were more lilely to own several types of livestock. This suggests that care must be taken when applying the findings from this study to the wider population.
...
The women participating in the study are a non-random sub-sample of the sample. In Table \ref{tab:attrition} I present results for logit regressions of sample selection indicators on various co-variates. In column 1, the dependent variable is whether there is a consenting female respondent in the household. In the second, the dependent variable whether there is a consenting male respondent, and the third whether both a consenting male and female respondent are present. 

EXPAND PLEASE

\begin{threeparttable}
	\caption{Sub-sample Selection (Logit)}\label{tab:attrition}
	\input{"C:/Users/Koen/Dropbox/PhD/Papers/CongoGBV/Tables/attrition.tex"}
	\begin{tablenotes}
	\small
	 \item Standard errors clustered at the village level
