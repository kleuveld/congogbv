...
This table is quite a bit of work.
...
mean_diff_table <- function(.df,var){
  #this runs three functions: 
  # one to get the means, by each value of var
  # one to get the differences in means
  # and one to get the difference in the differences
  ...
  df3 <- meandiff_did(.df,{{ var }})

  bind_rows(df1,df2,df3)
  
}

mean_diff_table(sample,victimfamlost) 

meandiff_did(sample,victimproplost)
