...
In this section, I compare what the different findings mean. For this,
I use a thought experiment, in which an imaginary NGO has capacity to 
run a project to assist women in ten villages. I compare three ways in 
which to select these villages:
...
I then compute how many women are helped in each case.
