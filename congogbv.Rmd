...
group is 2.65 (see Figure [1](#fig:meancompare_overall){reference-type="ref"
reference="fig:meancompare_overall"}). The difference of 0.31 issues implies that
...
coeffs %>%
  ...
  padding(padding.left = 0.5, padding.right = 0.5, part = "header") %>%
