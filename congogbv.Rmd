...
```{r table2}
 ...
 #caption
 set_caption(caption = "Gender module sample make up", 
              style = "Table Caption", 
              autonum = run_autonum(seq_id = "tab", bkm = "bargsample")) %>%
...
```{r table3}
 ...
 set_caption(caption = "Bargaining game lotteries", 
              style = "Table Caption", 
              autonum = run_autonum(seq_id = "tab", bkm = "risklotteries")) %>%
  theme_booktabs() %>%
  autofit()
