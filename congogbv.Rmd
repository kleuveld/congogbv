...
and the commune of Bagira.[^1] The baseline for this evaluation was done
...
read_csv(here("tables/table1.csv")) %>% 
  ...
  set_caption(caption = "Comparison of DHS and sample data", 
              style = "Table Caption", 
              autonum = run_autonum(seq_id = "tab", bkm = "dhscompare")) %>%
  knit_print()
...
interview [^2]. In the vast majority of the cases, the husband is
considered the head, but it was left open to the respondents to indicate
the head. Table [2](#tab:bargsample){reference-type="ref"
reference="tab:bargsample"} displays how the sample is built up. In
...
less likely than the provincial average. In Table
[6](#tab:sample_selection){reference-type="ref"
reference="tab:sample_selection"}, I present results from logit models
...
between high and low pay-outs (see Table
[3](#tab:bargaining){reference-type="ref" reference="tab:bargaining"}
...
[\[tab:balance\]](#tab:balance){reference-type="ref"
reference="tab:balance"} (Column 7) provides a comparison of the two
...
SGBV, equation [\[eq:basic\]](#eq:basic){reference-type="ref"
reference="eq:basic"} can be augmented using interaction terms as
follows: $$\label{eq:interaction}
...
&(1)&(2)&(3)&(4)&(5)&(6)&(7) &&&&(4)-(6) &N&Mean&N&Mean&N&Mean& Number
of reported issues&593&2.49&291&2.65&302&2.34&0.30\*\*\*
&&(0.94)&&(1.03)&&(0.83)& Conflict pre-2012: property
lost&530&0.77&264&0.79&266&0.75&0.04 &&(0.42)&&(0.41)&&(0.43)& Conflict
pre-2012: HH member killed&530&0.49&264&0.51&266&0.48&0.03
&&(0.50)&&(0.50)&&(0.50)& Conflict 2013--2014: Viol. against
civilians&496&6.73&239&6.68&257&6.77&--0.08 &&(4.69)&&(4.70)&&(4.69)&
Family MR had more land&450&0.33&224&0.33&226&0.33&--0.00
&&(0.47)&&(0.47)&&(0.47)& Family FR had more
land&450&0.21&224&0.22&226&0.19&0.02 &&(0.41)&&(0.41)&&(0.40)&
Bargaining: choice Female Respondent&593&3.58&291&3.59&302&3.56&0.04
&&(2.06)&&(2.08)&&(2.05)& Barganing: choice Male
Respondent&184&3.45&97&3.49&87&3.40&0.09 &&(2.14)&&(2.12)&&(2.18)&
Bargaining: closer to MR&184&0.40&97&0.37&87&0.44&--0.07
&&(0.49)&&(0.49)&&(0.50)& Bargaining: closer to
FR&184&0.27&97&0.32&87&0.21&0.11\* &&(0.44)&&(0.47)&&(0.41)& Age of
FR&593&41.09&291&40.49&302&41.67&--1.17 &&(14.01)&&(14.06)&&(13.96)& Age
of MR&449&45.67&224&44.48&225&46.85&--2.37\*\*
&&(13.80)&&(13.09)&&(14.40)& HH Head
Female&593&0.26&291&0.24&302&0.27&--0.03 &&(0.44)&&(0.43)&&(0.45)& FR
completed primary education&593&0.25&291&0.26&302&0.25&0.01
&&(0.44)&&(0.44)&&(0.43)& FR completed secondary
education&593&0.03&291&0.02&302&0.04&--0.02 &&(0.17)&&(0.13)&&(0.20)& MR
completed primary education&449&0.63&224&0.63&225&0.63&0.01
&&(0.48)&&(0.48)&&(0.48)& MR completed secondary
education&449&0.20&224&0.19&225&0.20&--0.01 &&(0.40)&&(0.39)&&(0.40)&
Household has a tin roof&593&0.61&291&0.62&302&0.59&0.03
&&(0.49)&&(0.49)&&(0.49)& Household owns
livestock&593&0.49&291&0.51&302&0.47&0.03 &&(0.50)&&(0.50)&&(0.50)&
territory==Uvira&593&0.24&291&0.24&302&0.23&0.01
&&(0.43)&&(0.43)&&(0.42)&
territory==Fizi&593&0.63&291&0.65&302&0.62&0.03
&&(0.48)&&(0.48)&&(0.49)& Project
Beneficary&593&0.50&291&0.49&302&0.50&--0.01 &&(0.50)&&(0.50)&&(0.50)&
:::
...
<figure id="fig:meancompare_overall">
<div class="center">
<embed src="figures/meancompare_overall.eps" />
</div>
<figcaption>Comparison of means of issues faced: treatment vs.
control.</figcaption>
</figure>
...
group is (see Figure [1](#fig:meancompare_overall){reference-type="ref"
reference="fig:meancompare_overall"}). The difference of implies that
the incidence of SGBV is % in this sample. The p-value for a t-test on
this difference is . This estimate appears substantially higher than
...
<figure id="fig:meancompare_conf">
<div class="center">
<embed src="figures/meancompare_conf.eps" />
</div>
<figcaption>Comparison of means of issues faced across conflict
exposure.</figcaption>
</figure>
...
[\[tab:balance\]](#tab:balance){reference-type="ref"
reference="tab:balance"}): % of the respondents reported having lost
property due to conflict between 1996 and 2012. % of the respondents
...
radius was . This exposure differs across the territories (Table
[4](#tab:conflict_by_terr){reference-type="ref"
reference="tab:conflict_by_terr"}). While respondents in all territories
...
more likely to be victimized in 2013-2014 (see also Table
[\[tab:determinants_regression\]](#tab:determinants_regression){reference-type="ref"
reference="tab:determinants_regression"}). Associations between pre-2012
violence and SGBV will thus not be the result of re-targeting of the
same households.

::: {#tab:conflict_by_terr}
  --------------------------------------------- --------------- --------- --------- ---------
...
[2](#fig:meancompare_conf){reference-type="ref"
reference="fig:meancompare_conf"}. From the top two panels, it can be
...
[\[tab:meandiff_conf\]](#tab:meandiff_conf){reference-type="ref"
reference="tab:meandiff_conf"}. Among those that indicated not having
...
in equation [\[eq:interaction\]](#eq:interaction){reference-type="ref"
reference="eq:interaction"} above) is not statistically significant.
...
[2](#fig:meancompare_conf){reference-type="ref"
reference="fig:meancompare_conf"}). SGBV incidence among women who have
more instances of violence near them than the median is 7 percentage
points lower than women who do not (bottom row of Table
[\[tab:meandiff_conf\]](#tab:meandiff_conf){reference-type="ref"
reference="tab:meandiff_conf"}). However, this is not statistically
...
![Comparison of means of issues faced by pre-marriage
status.](figures/meancompare_mar.eps){#fig:meancompare_mar
width="\\linewidth"}
...
choice. In % it was closer to the Female Respondent's. Note that the
size of the sample here is smaller than for the other variables
...
Figure [3](#fig:meancompare_mar){reference-type="ref"
reference="fig:meancompare_mar"} displays the results from the sub-group
...
[\[tab:meadifftab_mar\]](#tab:meadifftab_mar){reference-type="ref"
reference="tab:meadifftab_mar"}, these differences are tabulated,
...
[\[eq:interaction\]](#eq:interaction){reference-type="ref"
reference="eq:interaction"} to simultaneously include indicators for
...
[\[eq:interaction\]](#eq:interaction){reference-type="ref"
reference="eq:interaction"}, but estimation is more efficient.
...
Appendix, Table
[\[tab:determinants_regression\]](#tab:determinants_regression){reference-type="ref"
reference="tab:determinants_regression"}. In addition, I include
variables that determine sample selection, as displayed in Table
[6](#tab:sample_selection){reference-type="ref"
reference="tab:sample_selection"}. In particular, I include the age of
...
In Table [5](#tab:results_regression){reference-type="ref"
reference="tab:results_regression"} I display the results of these
...
[\[tab:determinants_regression\]](#tab:determinants_regression){reference-type="ref"
reference="tab:determinants_regression"}). Women who live in households
that lost a family or household member due to conflict prior to 2012 are
percentage points more likely to be victimized by SGBV than other women.
...
education are percentage points less likely to be victimized. The fact
...
::: {#tab:sample_selection}
  ...
  : Sample selection for the Gender Module
:::
...
[^1]: In the remainder of the paper, I will consider Kabare and Bagira
    to be one "territory", since the selected communities in Kabare and
    Bagira are located close together, in the peri-urban zone of Bukavu.

[^2]: In tables, I refer to Male and Female Respondents as MR and FR
    respectively.

[^3]: The results presented here are robust to using number of battles
